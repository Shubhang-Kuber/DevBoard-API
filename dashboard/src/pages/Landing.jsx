          ...
          <form onSubmit={submit} className="space-y-4">
            {mode === 'register' && (
              <input
                ...
                style={{ background: 'rgba(255,255,255,0.07)', border: '1px solid rgba(255,255,255,0.1)', boxShadow: 'none' }}
                onFocus={e => { e.target.style.border = '1px solid rgba(240,100,30,0.7)'; e.target.style.boxShadow = '0 0 0 3px rgba(240,100,30,0.15)'; }}
